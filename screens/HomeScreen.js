...
import { View, Text, StyleSheet, TouchableOpacity, Image, Button, ImageBackground, Alert, ScrollView } from "react-native";
...
const HomeScreen = () => {
    ...
    const [isModalVisiblereact, setModalVisiblereact] = useState(false);
    ...
    const moreinfofunc = (cardIndex) => {
        ...
        //   AsyncStorage.setItem("name", `${userSwiped.displayName}`);     this enables set item aysncsotrage
        //  setModalVisiblereact(!isModalVisiblereact);   this enables the modal on screen tap with bio
    };
    ...
    const setData = () => {
        AsyncStorage.setItem("name", "prads");
    }
    ...
    const toggleModal = () => {
        setModalVisiblereact(!isModalVisiblereact);
    };
    ...
    return (
        ...
        <SafeAreaView style={tw("flex-1")}>
            ...
            {userstatepro ?
                <View style={tw("absolute top-0.5 left-2")}>


                    {/* Header */}
                    <TouchableOpacity
                        style={tw("rounded-3xl w-20 h-8  ")}
                ...
                <View style={tw("absolute left-2 ")}>
                    ...
                    {/* Header */}
                    <TouchableOpacity
                        style={tw("rounded-3xl w-20 h-20 ")}
                                ...
                                card ? (
                                    ...
                                    >
                                        ...
                                        <View
                                            style={[
                                                tw(
                                                    "absolute bottom-20 justify-between flex-row w-full h-20 px-7 py-6 items-center"
                                                ),
                                                styles.cardShadow,
                                            ]}
                                        >
                                            ...
                                            {userstatepro ?
                                                <Text style={tw("text-sm font-bold text-white ")}>{card.Number}</Text>
                                                :
                                                <View></View>
                                        ...
                                        <View
                                            style={[
                                                tw(
                                                    "absolute bottom-11 justify-between flex-row w-full h-20 px-7 py-6 items-center"
                                                ),
                                                styles.cardShadow,
                                            ]}
                                        >
                                            <View>
                                                <Text style={tw("text-base font-bold text-white ")}>
                                                    {card.age} yrs, {card.Height} {'\u25AA'}  {card.Jobs}
                                                </Text>
                                        ...
                                        <View
                                            style={[
                                                tw(
                                                    "absolute bottom-4 justify-between flex-row w-full h-20 px-7 py-6 items-center"
                                                ),
                                                styles.cardShadow,
                                            ]}
                                        >
            ...
            <Modal
                onBackdropPress={() => setModalVisiblereact(false)}
                onBackButtonPress={() => setModalVisiblereact(false)}
                isVisible={isModalVisiblereact}
                swipeDirection="down"
                    ...
                    <View style={styles.center}>
                        ...
                        <ScrollView>
                            <Card containerStyle={styles.card}>
                                ...
                                <Text style={styles.cardText}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mattis sapien quis tristique volutpat. Ut vitae commodo sem, id varius eros. Fusce euismod ornare nunc, quis vulputate justo. Vivamus a malesuada lectus. Curabitur eu ipsum sem. </Text>
                            </Card>
                            <Card containerStyle={styles.card}>
                                <Text style={styles.cardTitle}>Bio</Text>
                                <Text style={styles.cardText}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mattis sapien quis tristique volutpat. Ut vitae commodo sem, id varius eros. Fusce euismod ornare nunc, quis vulputate justo. Vivamus a malesuada lectus. Curabitur eu ipsum sem. </Text>
